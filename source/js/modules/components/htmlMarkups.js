            ...
            <article class="item">
                <div class="item__media">
                    <figure class="item__figure">
                        <img class="item__image" src="../../public/img/photographers/${photographerId}/media/${image_url}" alt="${title}">
                    </figure>
                </div>            
  ...
  mediaVideoHtmlMarkup({ photographerId, video_url, likes, title, price, id }) {
    return `
            <article class="item">
                <div class="item__media">
                    <figure class="item__figure">
                        <video class="item__video" controls="controls" role="button" alt="${title}">
